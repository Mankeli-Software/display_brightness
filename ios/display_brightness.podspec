...
# Run `pod lib lint display_brightness.podspec` to validate before publishing.
#
Pod::Spec.new do |s|
  s.name             = 'display_brightness'
  s.version          = '0.1.0'
  s.summary          = 'Control app-level screen brightness using native interop.'
  s.description      = <<-DESC
